...
nearest Graphein type. Graphein 0.15 has a broad catalog, so most intents now have
a native type.
...
Graphein 0.15 still has **no radar/spider chart** (and no sunburst). Options, in
order:
